...
% making sure that first value of x is between 1 and 100000
while loopOn == 1
    x(1) = input("please enter a value for x between 1 and 100000: ");
...
% making sure that first value of y is between 1 and 100000
while loopOn == 1
    y(1) = input("please enter a value for y between 1 and 100000: ");
...
% making sure that first value of z is between 1 and 100000
while loopOn == 1
    z(1) = input("please enter a value for z between 1 and 100000: ");
...
% -------- checking the objects height above the 500km --------
...
radiusFromCenter = sqrt((x(1)^2)+(y(1)^2)+(x(1)^2));

% creating the length of the scalar vector
vS = sqrt(GM/radiusFromCenter);
